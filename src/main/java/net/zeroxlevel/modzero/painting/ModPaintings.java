package net.zeroxlevel.modzero.painting;
...
public class ModPaintings {
    ...
    private static PaintingVariant registerPainting(String name, PaintingVariant paintingVariant) {
        return Registry.register(Registry.PAINTING_VARIANT, new Identifier(ModZero.MOD_ID, name), paintingVariant);
    }

    public static void registerPaintings() {
        ModZero.LOGGER.debug("Registering Paintings for " + ModZero.MOD_ID);
    }
}
